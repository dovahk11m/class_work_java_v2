...
public class DBConnectionManager {
    ...
    static {
        ...
        config.setJdbcUrl("jdbc:mysql://192.168.0.184:3306/academy_management?serverTimezone=Asia/Seoul");
        config.setUsername("academy_admin");
        config.setPassword("ghkdlxld");
